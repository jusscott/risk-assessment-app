...
/**
 * Service Communication Resilience Test Runner
 * This script runs integration tests focused on service communication resilience
 */
...
async function main() {
  ...
  console.log(chalk.blue(`Starting service resilience tests at ${startTime.toISOString()}`));
  console.log(chalk.blue('==============================================='));
  ...
  try {
    ...
    console.log(chalk.blue('\n==============================================='));
    console.log(chalk.blue(`Service Resilience Test Summary:`));
